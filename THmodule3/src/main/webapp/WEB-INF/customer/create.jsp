                    ...
                    <div class="col-6">
                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="date" value="${requestScope.customer.getDate_of_birth()}" name="txtDateOfBirth"  id="example-date" name="example-date" class="form-control" >
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input name="txtPhoneNumber" value="${requestScope.customer.getPhone_number()}" type="phone" class="form-control" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 control-label" for="example-email">Email</label>
