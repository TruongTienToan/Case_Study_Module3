    ...
    <div class="col-6">
      ...
      <form method="post" >
        ...
        <div class="row mb-2">
          ...
          <input name="quantity"  class="col-8 form-control" value="${requestScope.product.getQuantity()}"  />
        </div>
        ...
        <div class="row">
          ...
          <a href="/product"><button type="button" class="mybutton btn btn-dark">Back</button></a>
        </div>
      </form>
    </div>
  </div>
